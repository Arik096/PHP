...
class SubmissionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'submission_category_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'fk_submissions_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_submissions_category_id' => ['type' => 'index', 'columns' => ['submission_category_id'], 'length' => []],
            'fk_submissions_manufacturer_id' => ['type' => 'index', 'columns' => ['manufacturer_id'], 'length' => []],
            'fk_submissions_scale_id' => ['type' => 'index', 'columns' => ['scale_id'], 'length' => []],
        ],
        '_constraints' => [
