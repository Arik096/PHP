 ...
 * ModelTypesFixture
 */
class ModelTypesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_model_types_status_id' => ['type' => 'index', 'columns' => ['status_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_model_types_status_id' => ['type' => 'foreign', 'columns' => ['status_id'], 'references' => ['statuses', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status_id' => 1,
                'created' => '2020-06-14 15:39:24',
                'modified' => '2020-06-14 15:39:24',
            ],
        ];
        parent::init();
    }
