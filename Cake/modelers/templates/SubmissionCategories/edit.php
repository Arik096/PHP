...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $submissionCategory->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $submissionCategory->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="submissionCategories form content">
            ...
            <fieldset>
                <legend><?= __('Edit Submission Category') ?></legend>
                <?php
